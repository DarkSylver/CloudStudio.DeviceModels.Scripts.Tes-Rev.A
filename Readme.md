...
# Parsing + Configuration Script – Tes  - Rev. A

This **Parsing + Configuration** script is designed for the **Tes ** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Tes  Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Tes ** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
